...
class DamnWheel(Entertainment):
    def __init__(self, name: str = "", price: int = 0, height: int = 0, max_people: int = 0,  max_num_of_kids: int = 0,
        ...
        self.__number_of_circles = number_of_circles
        self.__construction_height = construction_height

    def __str__(self):
        res4 = super().__str__() + f"\nNumbers_of_circles: {self.__number_of_circles}\nConstruction_height: {self.__construction_height}"
        return res4
